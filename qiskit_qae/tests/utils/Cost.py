...
### Runs a circuit with all qubits measured and returns angular positions of all qubits
...
class Cost:
    ...
    def cost_fun(self, params_values, *args):
        ...
        if self.cost_type == Cost.type_swap:
            ...
            cost = cost_zero_log(probs)
        elif self.cost_type == Cost.type_negzeros:
            cost = cost_neg_zero(probs)
